...
window.onload = function () {
  ...
  percentuale.innerText = Math.floor((punteggio / totaleDomande) * 100) + '%'
  ...
  percentuale_sbagliate.innerText =
    Math.floor((risposteSbagliate / totaleDomande) * 100) + '%'
  ...
  grafico.style.background = `conic-gradient(deepskyblue ${parseInt(
    percentuale.innerText
  )}% 0%, orangered 0% 0%)`
  console.log(grafico)
